      ...
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              <a href="mailto:contato@b3tech.com.br" className="text-sm text-b3-text-secondary hover:text-b3-accent transition-colors">
                ✉️ contato@b3tech.com.br
              </a>
              <a href="#" className="text-sm text-b3-text-secondary hover:text-b3-accent transition-colors">
                📞 (00) 00000-0000
              </a>
        ...
        <div className="border-t border-white/8 pt-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-[13px] text-b3-text-muted">
            © 2026 B3 Tech Solutions. Todos os direitos reservados.
          </p>
